...
import { ParsedAccount } from '../../../frameworks/react/src/contexts/accounts/types';
import { getEmptyMetaState } from './getEmptyMetaState';
import { getMultipleAccounts } from '../../../frameworks/react/src/contexts/accounts/getMultipleAccounts';
...
const pullEditions = async (
  ...
  const result = await Promise.all(editionPromises);
  console.log('pulleed EDITIONS', result);
};

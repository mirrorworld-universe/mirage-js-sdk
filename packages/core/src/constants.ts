...
export const MIRAGE_AUCTION_HOUSE = new PublicKey(
  'FW6o4vELLA4NojBdTjNGz1F7apWoj6Jtwb1YNbSdyB1X'
);
...
export const MIRAGE_AUCTION_HOUSE_AUTHORITY = new PublicKey(
  'Cq4P18vbjMQNE7J2nMme4RMpRyVFf8PGFNkvh5ecC4jF'
);

      ...
      <c-modal-content>
                ...
                <c-stack px="4" py="3">
                  ...
                  <c-h-stack justify="space-between" align="center">
                    ...
                    <c-icon-button
                      ...
                      as="a"
                      target="_blank"
                      :href="`https://explorer.solana.com/address/${newNFT.mint.toString()}?cluster=${'devnet'}`"
                      rounded="full"
                    />
                  </c-h-stack>
                </c-stack>
        ...
        <c-modal-footer>
          <c-h-stack v-if="newNFT" justify-content="flex-end">
            <c-button as="a" size="lg" :href="`https://explorer.solana.com/address/${newNFT?.mint.toString()}?cluster=${'devnet'}`">
              View in explorer
            </c-button>
            <c-button
              @click="
